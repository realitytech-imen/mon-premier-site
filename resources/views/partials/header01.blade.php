    ...
    <header class="main_menu home_menu" style="background-color: white;">
        <div class="container"> <!-- replace main_menu par menu_fixed -->
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="{{ route('accueil') }}"> <img src="img/logo_imen.png" alt="logo"> </a>
                        <button class="navbar-toggler" type="button" data-toggle="collapse"
                            data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
                            aria-expanded="false" aria-label="Toggle navigation">
                            <span class="navbar-toggler-icons"><i class="fa-solid fa-bars"></i></span>
                        </button>
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="portfolio_etudants" href="{{ route('portfolio_etudants') }}">PORTFOLIO ETUDIANTS</a>
                                </li>
