...
@section('title')
    Institut des Métiers du Numérique (IMeN) | Porfolio Etudiants
@endsection
...
@section('content')
    ...
    <p style="text-align: center; margin: 25px;">
        ...
        <a style="padding-left:34px; padding-right:34px;" href="{{ route('decouvrir_certif') }}" class="btn_2">LA CERTIFICATION </a>
    </p>
@endsection