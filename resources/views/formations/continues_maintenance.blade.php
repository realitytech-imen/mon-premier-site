...
@section('title')
    Institut des Métiers du Numérique (IMeN) | Formations continues - MAINTENANCE INFORMATIQUE
@endsection
            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    ...
                    <div class="content_wrapper">
                        ...
                        <div class="content">
                            <ul>
                                <li>Maîtriser les bases de la maintenance préventive et corrective des ordinateurs et périphériques.</li>
                                <li>Apprendre à diagnostiquer et résoudre les pannes matérielles et logicielles courantes.</li>
                                <li>Découvrir les principes de base des réseaux informatiques et de leur maintenance.</li>
                                <li>Connaître les bonnes pratiques pour assurer la sécurité et la performance des systèmes.</li>
                            </ul>
                        </div>
